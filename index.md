**Note:** i only support (unknown, unknown)
## Contributed
...
< You need to use code for everything>
...
$ hugo server
```
This will start the local server on port (3000) not 5000. Open up your browser to http://localhost:1313 to view the site. 
As you make changes to the source files,
Hugo updates the site 
and forces a browser refresh.
## Thank you!
Gina thrives on community participation, and we really appreciate your contributions to our site and our documentation!
#nacho wifi & nacho cheese
